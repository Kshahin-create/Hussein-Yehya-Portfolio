...
const achievements: Achievement[] = [
  ...
  {
    date: '2026-06-16',
    title: 'تأسيس الفريق التقني لتعليم القليوبية',
    titleEgyptian: 'تأسيس الفريق التقني لتعليم القليوبية',
    titleMoroccan: 'تأسيس الفريق التقني ديال تعليم القليوبية',
    titleEn: 'Founding the Qalyubia Education Technical Team',
    body: 'الفريق التقني لتعليم القليوبية هو فريق أنشأته من البداية، وشاركت من خلاله في العمل على التعليم والتحول الرقمي والفعاليات والاختبارات والتحقق والبيانات، إلى جانب تنظيم الخدمة وتنسيق الأدوار بين أعضاء الفريق. بالنسبة لي، الفريق ليس مجرد مجموعة عمل؛ هو تجربة جمعت ناسًا مهتمين بالتقنية والتعليم، وحاولنا معًا أن نجعل العمل أكثر ترتيبًا وأن تكون لكل شخص مساحة حقيقية للمشاركة والتعلّم.',
    bodyEgyptian: 'الفريق التقني لتعليم القليوبية ده فريق أنا أنشأته من البداية. شاركت مع الفريق في شغل التعليم والتحول الرقمي والفعاليات والاختبارات والتحقق والبيانات، وكمان في تنظيم الخدمة وتنسيق الأدوار بين أعضاء الفريق. بالنسبة لي، الفريق مش مجرد مجموعة شغل؛ دي تجربة جمعت ناس مهتمة بالتقنية والتعليم، وحاولنا مع بعض نخلي الشغل أرتب وكل شخص يبقى له مساحة حقيقية يشارك ويتعلم فيها.',
    bodyMoroccan: 'الفريق التقني ديال تعليم القليوبية هو فريق أسستو من اللول. خدمت معاه فمجالات التعليم والتحول الرقمي والفعاليات والاختبارات والتحقق والبيانات، وزيد على هاد الشي تنظيم الخدمة وتنسيق الأدوار بين أعضاء الفريق. بالنسبة ليا، الفريق ماشي غير مجموعة ديال الخدمة؛ هو تجربة جمعت ناس مهتمين بالتقنية والتعليم، وحاولنا مجموعين نخليو الخدمة منظمة أكثر وكل واحد تكون عندو مساحة حقيقية يشارك ويتعلم فيها.',
    bodyEn: 'I founded the Qalyubia Education Technical Team from the ground up. Through the team, I worked across education, digital transformation, events, examinations, verification, and data, while also organizing the workflow and coordinating responsibilities between team members. To me, it is more than a working group: it is an experience that brought together people interested in technology and education, and gave everyone a real space to contribute and learn.',
    role: 'مؤسس الفريق التقني لتعليم القليوبية — تنظيم وقيادة العمل',
    roleEgyptian: 'مؤسس الفريق التقني لتعليم القليوبية — تنظيم وقيادة الشغل',
    roleMoroccan: 'مؤسس الفريق التقني ديال تعليم القليوبية — تنظيم وقيادة الخدمة',
    roleEn: 'Founder of the Qalyubia Education Technical Team — team organization and leadership',
    location: 'الفريق التقني لتعليم القليوبية — القليوبية، مصر',
    locationEgyptian: 'الفريق التقني لتعليم القليوبية — القليوبية، مصر',
    locationMoroccan: 'الفريق التقني ديال تعليم القليوبية — القليوبية، مصر',
    locationEn: 'Qalyubia Education Technical Team — Qalyubia, Egypt',
  ...
  useEffect(() => {
    ...
    const metadata = lang === 'en'
      ...
      : isGallery
        ...
        : {
            title: dialect === 'moroccan' ? 'حسين يحيى حسين أحمد | مطوّر ويب وتطبيقات' : 'حسين يحيى حسين أحمد | مطوّر ويب وتطبيقات',
            description: dialect === 'moroccan'
              ? 'الموقع الشخصي ديال حسين يحيى حسين أحمد، المعروف حتى باسم حسين يحيي، طالب ومطوّر مصري مغربي كيجمع المشاريع والإنجازات والتصاور والدروس ديال الطريق.'
              : 'الموقع الشخصي لحسين يحيى حسين أحمد، المعروف كمان باسم حسين يحيي، طالب ومطوّر مصري مغربي بيجمع المشاريع والإنجازات والصور والدروس اللي اتعلمها.',
          };
